    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/sales/*/payments")
                        .access(temporaryOrAuthority("SALE_PAYMENT_MODIFY"))
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/route-sales/*/payments")
                        .access(temporaryOrAuthority("ROUTE_PAYMENT_MODIFY"))
